...
import (
	...
	controllerstrishankuorgv1alpha1 "github.com/trishanku/heaven/api/v1alpha1"
	"github.com/trishanku/heaven/controllers"
...
func init() {
	...
	utilruntime.Must(controllerstrishankuorgv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	var defaultEtcdImage string
	var defaultCfsslImage string
	var defaultKubectlImage string
	...
	flag.StringVar(&defaultEtcdImage, "default-etcd-image", "bitnami/etcd:3", "Default etcd image.")
	flag.StringVar(&defaultCfsslImage, "default-cfssl-image", "cfssl/cfssl:1.6.1", "Default cfssl image.")
	flag.StringVar(&defaultKubectlImage, "default-kubectl-image", "bitnami/kubectl:1.24.4", "Default cubectl image.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "dd79ba93.trishanku.org",
	...
	if err = (&controllers.GitHubRepositoryReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
