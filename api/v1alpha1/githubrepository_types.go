...
type GitHubRepositorySpec struct {
	...
	// CredentialsSecretName specifies the secret containing the GitHub credentials.
	CredentialsSecretName string `json:"credentialsSecretName,omitempty"`

	// CredentialsSecretTokenKey specifies key name to look up the credentials token from the credentials secret.
	// +Required
	CredentialsSecretTokenKey string `json:"credentialsSecretTokenKey,omitempty"`

	// Organization for the GitHub repository.
	// +Optional
	...
	// Private specifies if the GitHub repository should be private.
	// +Optional
